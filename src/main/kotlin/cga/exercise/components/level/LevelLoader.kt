...
object LevelLoader {
    ...
    fun loadLevel3(): Level {
        // Texturen laden
        val diffuseWall = Texture2D("assets/textures/painted_plaster_wall_diff_2k.jpg", true)
        val roughWall = Texture2D("assets/textures/painted_plaster_wall_diff_2k.jpg", true)
        val normalWall = Texture2D("assets/textures/painted_plaster_wall_nor_gl_2k.jpg", true)

        val diffuseGround = Texture2D("assets/textures/wood_floor_diff_2k.jpg", true)
        ...
        // Obj 1 (Cube)
        val obj1 = loadOBJ("assets/models/DesignChair_T1.obj")
        val obj1MeshList = obj1.objects[0].meshes
        val obj1Attribs = arrayOf(
            VertexAttribute(3, GL_FLOAT, 32, 0),
            VertexAttribute(2, GL_FLOAT, 32, 12),
        ...
        // Obj 2 (Cone)
        val obj2 = loadOBJ("assets/models/DesignChair_T2.obj")
        val obj2MeshList = obj2.objects[0].meshes
        val obj2Attribs = arrayOf(
            VertexAttribute(3, GL_FLOAT, 32, 0),
            VertexAttribute(2, GL_FLOAT, 32, 12),
        ...
        // Obj 3 (Zylinder)
        val obj3 = loadOBJ("assets/models/DesignChair_T3.obj")
        val obj3MeshList = obj3.objects[0].meshes
        val obj3Attribs = arrayOf(
            VertexAttribute(3, GL_FLOAT, 32, 0),
            VertexAttribute(2, GL_FLOAT, 32, 12),
