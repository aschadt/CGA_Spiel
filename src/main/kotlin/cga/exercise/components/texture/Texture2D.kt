...
class Texture2D(imageData: ByteBuffer, width: Int, height: Int, genMipMaps: Boolean): ITexture{
    ...
    init {
        ...
        //println("Loaded Texture2D ID=$texID")
    ...
    // verarbeitet das geladene Bild und lädt es zu OpenGL hoch
    override fun processTexture(imageData: ByteBuffer, width: Int, height: Int, genMipMaps: Boolean) {
        ...
        // Mipmaps erzeugen, falls gewünscht
    ...
    override fun bind(textureUnit: Int) {
        // Aktiviere den gewünschten Texture-Unit (GL_TEXTURE0 + N)
        GL13.glActiveTexture(GL13.GL_TEXTURE0 + textureUnit)
        // Binde die Textur an das Ziel 2D
        GL11.glBindTexture(GL11.GL_TEXTURE_2D, texID)
    }

    override fun unbind() {
        // Binde 0, um die Textur vom Ziel zu entbinden
        GL11.glBindTexture(GL11.GL_TEXTURE_2D, 0)
    }
